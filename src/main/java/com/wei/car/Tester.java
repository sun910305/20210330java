...
public class Tester {
    public static void main(String[] args) {
        ...
        if(car == null){
            ...
            System.out.println("Time:" + mins + "分鐘 " + "Fee:" + fee*mins + "元");
        }
    }
}
/* practice
        ...
        cal.set(Calendar.HOUR_OF_DAY, 8);//小時
        cal.set(Calendar.MINUTE, 30);//分鐘

        System.out.println(cal.getTime());

        Car c1 = new Car("abc-123");
        Car c2 = new Car("xyz-888", "7:30");
